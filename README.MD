# Drewpy Path Knocker
A zero-trust dynamic IP whitelisting system using free public cloud resources. Friends and family visit a secret URL to register their IP, which propagates to your security controls automatically.
